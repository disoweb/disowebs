                ...
                <div class="tw-flex tw-justify-between tw-items-center tw-mb-4">
                    <div>
                        <h4 class="tw-font-semibold tw-text-lg tw-text-neutral-800 tw-my-0">
                            ...
                            <?php echo _l('disowebs_ops_followups_overdue_title'); ?>
                        </h4>
                        <p class="tw-text-neutral-500 tw-mb-0"><?php echo _l('disowebs_ops_followups_overdue_desc'); ?></p>
                    </div>
                </div>

                <!-- Urgency Alert - only show if there are overdue followups -->
                <?php if (!empty($leads)) { ?>
                <div class="alert alert-danger">
                    <i class="fa fa-clock tw-mr-2"></i>
                    <strong><?php echo _l('disowebs_ops_followups_overdue_alert'); ?></strong>
                    <p class="tw-mt-2 tw-mb-0">
                        <?php echo _l('disowebs_ops_followups_overdue_alert_desc'); ?>
                    </p>
                </div>
                <?php } ?>
                ...
                <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 tw-gap-4 tw-mb-6">
                    <div class="panel_s tw-mb-0">
                        <div class="panel-body tw-text-center">
                            ...
                            <div class="tw-text-sm tw-text-neutral-500"><?php echo _l('disowebs_ops_overdue_followups'); ?></div>
                        </div>
                    </div>
                    <div class="panel_s tw-mb-0">
                        <div class="panel-body tw-text-center">
                            ...
                            foreach ($leads as $lead) {
                                if ($lead['days_overdue'] > $max_days) {
                                    $max_days = $lead['days_overdue'];
                                }
                            }
                            ?>
                            <div class="tw-text-3xl tw-font-bold tw-text-warning"><?php echo e($max_days); ?></div>
                            <div class="tw-text-sm tw-text-neutral-500"><?php echo _l('disowebs_ops_max_days_overdue'); ?></div>
                        </div>
                    </div>
                    <div class="panel_s tw-mb-0">
                        <div class="panel-body tw-text-center">
                            <?php 
                            $avg_days = count($leads) > 0 ? round(array_sum(array_column($leads, 'days_overdue')) / count($leads), 1) : 0;
                            ?>
                            <div class="tw-text-3xl tw-font-bold tw-text-info"><?php echo e($avg_days); ?></div>
                            <div class="tw-text-sm tw-text-neutral-500"><?php echo _l('disowebs_ops_avg_days_overdue'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="tw-text-center tw-py-10">
                            ...
                            <h5 class="tw-font-semibold tw-text-neutral-800"><?php echo _l('disowebs_ops_no_overdue_followups'); ?></h5>
                            <p class="tw-text-neutral-500"><?php echo _l('disowebs_ops_no_overdue_followups_desc'); ?></p>
                        </div>
                        <?php } else { ?>
                            ...
                            <table class="table table-striped dt-table" data-order-col="5" data-order-type="desc">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo _l('disowebs_ops_followup_date'); ?></th>
                                        <th><?php echo _l('disowebs_ops_days_overdue'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                    $urgency_class = '';
                                    if ($lead['days_overdue'] >= 14) {
                                        $urgency_class = 'tw-bg-red-50';
                                    } elseif ($lead['days_overdue'] >= 7) {
                                    ...
                                    <tr class="<?php echo $urgency_class; ?>">
                                        ...
                                        <td data-order="<?php echo e($lead['days_overdue']); ?>">
                                            <span class="tw-font-bold tw-text-danger">
                                                <?php echo e($lead['days_overdue']); ?> days overdue
                                            </span>
                                        </td>
                                        <td>
