                ...
                <div class="tw-flex tw-items-center tw-justify-between tw-mb-6">
                    <div>
                        <h4 class="tw-text-2xl tw-font-bold tw-text-neutral-800 tw-mb-1">
                            <i class="fa fa-money-bill-wave tw-mr-2" style="color: #d97706;"></i>
                            <?php echo e($title); ?>
                        </h4>
                        <p class="tw-text-neutral-500 tw-mb-0"><?php echo _l('disowebs_ops_final_pending_desc'); ?></p>
                    </div>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="tw-flex tw-items-center tw-gap-4 tw-mb-4">
                            ...
                            <div>
                                <h5 class="tw-font-semibold tw-text-neutral-800 tw-mb-1"><?php echo _l('disowebs_ops_projects_awaiting_final'); ?></h5>
                                <p class="tw-text-neutral-500 tw-text-sm tw-mb-0"><?php echo _l('disowebs_ops_final_pending_help'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="tw-text-center tw-py-12">
                            ...
                            <h5 class="tw-font-semibold tw-text-neutral-800"><?php echo _l('disowebs_ops_all_payments_cleared'); ?></h5>
                            <p class="tw-text-neutral-500"><?php echo _l('disowebs_ops_all_payments_cleared_desc'); ?></p>
                        </div>
                        <?php } else { ?>
                            ...
                            <table class="table dt-table" data-order-col="0" data-order-type="asc">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo _l('disowebs_ops_total'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $required = (float)($project['final_payment_required'] ?? 0);
                                    $paid = (float)($project['final_payment_paid'] ?? 0);
