...
"use strict";
  ...
  var dataRowCount = <?php echo count($data_workload['data']); ?>;
  var calculatedHeight = Math.max(150, Math.min(400, (dataRowCount * 35) + 80));
  if (isMobile) {
    calculatedHeight = Math.max(120, Math.min(300, (dataRowCount * 30) + 60));
  }
