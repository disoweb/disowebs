      ...
      <div class="panel_s">
        <div class="panel-body">
          ...
          <div class="mbot15" style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
            <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#balance-sheet-detail-filters" style="border: 1px solid #ccc;">
          ...
          <div class="collapse" id="balance-sheet-detail-filters">
            <div class="row">
