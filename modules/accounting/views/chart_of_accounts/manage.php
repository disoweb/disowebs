      ...
      <div class="panel_s">
        <div class="panel-body">
          ...
          <div class="mbot15" style="display: flex; gap: 10px; align-items: center;">
            <a href="#" class="btn btn-info add-new-account"><?php echo _l('add'); ?></a>
            <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#coa-filters">
              <i class="fa fa-filter"></i> <?php echo _l('filter'); ?>
            </button>
          </div>
          <div class="collapse" id="coa-filters">
            <div class="row">
