    ...
    <div class="row">
      <div class="panel_s">
        <div class="panel-body">
          ...
          <hr />
          <div class="mbot15" style="display: flex; gap: 10px; align-items: center;">
            <a href="#" class="btn btn-info add-new-transfer"><?php echo _l('add'); ?></a>
            <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#transfer-filters">
              <i class="fa fa-filter"></i> <?php echo _l('filter'); ?>
            </button>
          </div>
          <div class="collapse" id="transfer-filters">
            <div class="row">
