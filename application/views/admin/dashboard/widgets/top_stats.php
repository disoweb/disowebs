...
<div class="widget relative" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('quick_stats'); ?>">
    ...
    <div class="tw-grid tw-grid-cols-2 sm:tw-flex sm:tw-flex-row tw-gap-x-4 tw-gap-y-2">
      ...
      ?>
        ...
        <div class="quick-stats-invoices sm:tw-flex-1">
        ...
        <div class="quick-stats-leads sm:tw-flex-1">
            <div class="top_stats_wrapper">
                <?php
                  $where = '';
                  if (!is_admin()) {
        ...
        <?php } ?>
        <div class="quick-stats-projects sm:tw-flex-1">
            <div class="top_stats_wrapper">
                <?php
                  $_where         = '';
                ...
                <div class="tw-font-semibold tw-text-neutral-600 tw-text-lg tw-mt-1 sm:tw-hidden">
                    <?php echo e($total_projects_in_progress); ?> / <?php echo e($total_projects); ?>
                </div>
        ...
        <div class="quick-stats-tasks sm:tw-flex-1">
            <div class="top_stats_wrapper">
                <?php
                  $_where = '';
