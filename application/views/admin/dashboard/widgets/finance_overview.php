        ...
        <div class="panel_s">
            <div class="panel-body padding-15">
                ...
                <div class="row home-summary">
                    ...
                    <div class="col-md-6 col-lg-<?= e($totalColumnsLg); ?> col-sm-6">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="text-neutral-700 tw-mb-4 tw-inline-flex tw-items-center tw-space-x-1.5 rtl:tw-space-x-reverse -tw-mt-2">
                            ...
                            <div class="col-md-12">
                                <dl class="tw-grid tw-grid-cols-2 tw-gap-2 tw-mb-0">
                                    ...
                                    <a href="<?= admin_url('invoices/list_invoices?status=6'); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                            <dt class="tw-font-normal text-muted">
                                                <?= format_invoice_status(6, '', false); ?>
                                            </dt>
                                            <dd class="tw-mt-1 tw-font-semibold tw-text-neutral-600">
                                                <?= e($percent_data['total_by_status']); ?>
                                            </dd>
                                        </div>
                                    </a>
                                    <?php $percent_data = get_invoices_percent_by_status('not_sent'); ?>
                                    <a href="<?= admin_url('invoices/list_invoices?not_sent=1'); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                            <dt class="tw-font-normal text-muted">
                                    ...
                                    <a href="<?= admin_url('invoices/list_invoices?status=1'); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                    ...
                                    <a href="<?= admin_url('invoices/list_invoices?status=3'); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                    ...
                                    <a href="<?= admin_url('invoices/list_invoices?status=4'); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                            <dt class="tw-font-normal text-warning">
                                    ...
                                    <a href="<?= admin_url('invoices/list_invoices?status=2'); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                    ...
                    <div class="col-md-6 col-lg-<?= e($totalColumnsLg); ?> col-sm-6">
                        <div class="row">
                            <div class="col-md-12 text-stats-wrapper">
                                <p class="text-neutral-700 tw-mb-4 tw-mt-6 sm:tw-mt-0 tw-inline-flex tw-items-center tw-space-x-1.5 rtl:tw-space-x-reverse">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor"
                                        class="tw-6 tw-h-6 tw-text-neutral-500">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="col-md-12">
                                <dl class="tw-grid tw-grid-cols-2 tw-gap-2 tw-mb-0">
                                    ...
                                    <a href="<?= e($url); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                            <dt class="tw-font-normal text-<?= estimate_status_color_class($status, true); ?>">
                    ...
                    <div class="col-md-12 col-sm-6 col-lg-<?= e($totalColumnsLg); ?>">
                        <div class="row">
                            <div class="col-md-12 text-stats-wrapper">
                                <p class="text-neutral-700 tw-mb-4 tw-mt-6 sm:tw-mt-0 tw-inline-flex tw-items-center tw-space-x-1.5 rtl:tw-space-x-reverse">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <div class="col-md-12">
                                <dl class="tw-grid tw-grid-cols-2 tw-gap-2 tw-mb-0">
                                    ...
                                    <a href="<?= e($url); ?>" class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-md tw-bg-white tw-block hover:tw-bg-neutral-50 tw-transition">
                                        <div class="tw-px-4 tw-py-5 sm:tw-px-4 sm:tw-py-2">
                                            <dt class="tw-font-normal text-<?= proposal_status_color_class($status, true); ?>">
