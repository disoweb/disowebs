                ...
                <div class="col-md-12">
                    ...
                    <div class="_buttons">
                        <div class="md:tw-flex md:tw-items-center">
                            <div class="tw-flex tw-gap-2 tw-mb-2 md:tw-mb-0">
                            ...
                            <a href="<?= admin_url('projects/gantt'); ?>"
                                ...
                                class="btn btn-default btn-with-tooltip tw-whitespace-nowrap sm:!tw-px-3">
                                <i class="fa fa-align-left" aria-hidden="true"></i>
                                <span class="md:tw-hidden tw-ml-1"><?= _l('project_gant'); ?></span>
                            </a>
                            <div class="md:tw-hidden tw-min-w-[80px]">
                                <app-filters
                                    id="<?= $table->id(); ?>-mobile"
                                    view="<?= $table->viewName(); ?>"
                                    ...
                                    <button type="button" class="btn btn-default tw-whitespace-nowrap">
                                        <i class="fa fa-filter tw-mr-1"></i>
                                        <?= _l('dt_button_filters'); ?>
                                    </button>
                                </app-filters>
                            </div>
                            </div>
                            ...
                            <div class="tw-hidden md:tw-block ltr:tw-ml-auto rtl:tw-mr-auto">
                                <app-filters
                                    id="<?= $table->id(); ?>"
                                    view="<?= $table->viewName(); ?>"
                                    :rules="extra.projectsRules || <?= app\services\utilities\Js::from($this->input->get('status') ? $table->findRule('status')->setValue([(int) $this->input->get('status')]) : []); ?>"
