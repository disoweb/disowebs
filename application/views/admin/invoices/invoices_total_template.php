...
<?php $badge = $this->input->post('display_type') === 'badge' || (isset($badge_display) && $badge_display === true); ?>
...
<div class="tw-relative">
    <div class="tw-grid tw-grid-cols-2 md:tw-flex md:tw-items-center tw-gap-1 tw-mb-0">

        <div class="tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-lg tw-shrink-0 tw-bg-white">
            <div class="tw-px-2 md:tw-px-1.5 tw-py-1.5 md:tw-py-0.5 tw-text-sm tw-flex tw-flex-col md:tw-flex-row md:tw-gap-2">
        ...
        <div class="tw-col-span-2 md:tw-col-auto tw-border tw-border-solid tw-border-neutral-300/80 tw-rounded-lg tw-shrink-0 tw-bg-white">
