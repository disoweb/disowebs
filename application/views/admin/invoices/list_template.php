...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12 tw-mb-2">
            <div class="_buttons tw-grid tw-grid-cols-2 sm:tw-flex sm:tw-flex-row tw-gap-2 sm:tw-space-x-1 rtl:sm:tw-space-x-reverse">
                <?php if (staff_can('create', 'invoices')) { ?>
                <a href="<?= admin_url('invoices/invoice'); ?>"
                    class="btn btn-primary new new-invoice-list tw-text-center">
                ...
                <button id="add-batch-payment" onclick="add_batch_payment()" class="btn btn-default tw-text-center">
                ...
                <a href="<?= admin_url('utilities/bulk_pdf_exporter?feature=invoices'); ?>"
                    ...
                    class="btn-with-tooltip btn btn-default tw-text-center !tw-px-3">
                    <i class="fa-regular fa-file-pdf"></i>
                </a>
                <?php } ?>
                <?php } ?>
                <div class="tw-space-x-0 sm:tw-space-x-1.5 rtl:tw-space-x-reverse sm:tw-ml-auto">
                ...
                <div class="clearfix sm:tw-hidden"></div>
            </div>
        </div>
