...
$(function () {
  ...
  // Handle minimalize sidebar menu (desktop only)
  $(".hide-menu").click(function (e) {
    e.preventDefault();
    // Only handle desktop sidebar toggle, not mobile
    if ($(window).width() >= 768) {
  ...
  (function initMobileDropdownNav() {
    var $dropdown = $("#mobileDropdown");
    var $toggle = $("#mobileDropdownToggle");
    ...
    // Tab switching
    $dropdown.on("click", ".mobile-dropdown-tab", function() {
      var $tab = $(this);
      var tabName = $tab.data("tab");
      
      $dropdown.find(".mobile-dropdown-tab").removeClass("active");
      $tab.addClass("active");
      
      $dropdown.find(".mobile-dropdown-panel").removeClass("active");
      $dropdown.find('[data-panel="' + tabName + '"]').addClass("active");
    });

    // Submenu toggle
    $dropdown.on("click", "[data-submenu]", function(e) {
      e.preventDefault();
      var $btn = $(this);
      var $item = $btn.closest(".mobile-dropdown-item");
    ...
    $(document).on("click", function(e) {
      if (!$(e.target).closest("#mobileDropdown, #mobileDropdownToggle").length) {
        $dropdown.removeClass("active");
      }
    });
